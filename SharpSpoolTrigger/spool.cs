...
namespace SharpSpoolTrigger
{
    public class rprn : rpcapi
    {
        ...
        [SecurityPermission(SecurityAction.LinkDemand, Flags = SecurityPermissionFlag.UnmanagedCode)]
        public Int32 RpcOpenPrinter(string pPrinterName, out IntPtr pHandle, string pDatatype, ref NativeMethods.DEVMODE_CONTAINER pDevModeContainer, Int32 AccessRequired)
        {
