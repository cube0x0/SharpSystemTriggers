...
{
    //https://raw.githubusercontent.com/vletoux/pingcastle/19a3890b214bff7cb66b08c55bb4983ca21c8bd1/RPC/rpcapi.cs{
    public abstract class rpcapi
    {
        ...
        private bind BindDelegate;

        private unbind UnbindDelegate;
        ...
        private delegate IntPtr bind(IntPtr IntPtrserver);
        ...
        private delegate void unbind(IntPtr IntPtrserver, IntPtr hBinding);
